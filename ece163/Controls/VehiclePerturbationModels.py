...
def CreateTransferFunction(trimState, trimInputs):
    ...
    mytf.a_theta2 = 0
    mytf.a_theta3 = 0
    mytf.a_V1 = ((VPC.rho*(trimState.Va**2)* VPC.S)/VPC.mass)*(-VPC.CD0 + VPC.CDalpha*trimState.alpha - VPC.CDdeltaE*trimInputs.Elevator) + (1/VPC.mass * dThrust_dVa(trimState.Va,trimInputs.Throttle))
    mytf.a_V2 = 0
